/****************************************************************************************
*                                                                                       *
*	Title:   Modifying data stored in an array                                          *
*	Author:  Ayaan                                                                      *
*	Date:    05/07/2025                                                                 *
*	Purpose: Assigning values to elements in an array                                   *
*                                                                                       *
*****************************************************************************************/
#include <iostream>
...
int main() {
    ...
    int myNumbers[ARRAY_LENGTH] = { 5, 10, 0, 20 };

    // Using constexpr for array of 25 integers
