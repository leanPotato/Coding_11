...
// Defining functions
double give_Gross_Pay(double hours_Worked);  					 // Calculate gross pay
double overtime_Payment(double gross_Pay, double hours_Worked);  // Calculate overtime payment

int main() {

	// State all variables
	double hours_Worked, dependents, gross_Pay, new_Social_Security_Tax, new_Federal_Tax,
		   new_State_Tax, take_Home_Pay;
	...
	if (hours_Worked > 40) {
		...
		gross_Pay = overtime_Payment(gross_Pay, hours_Worked);
