...
void calc_Gross_and_Tax(double hoursWorked=0, double dependents=0, float PAYMENT_PER_HOUR = 16.78, float SOCIAL_SECURITY_TAX = 0.06,
                        float FEDERAL_INCOME_TAX = 0.14, float UNION_DUES = 10, float WITHHELD_DEPENDENTS = 35,
                        float OVERTIME_RATE = 1.5, float STATE_INCOME_TAX = 0.05);  // Calculate gross and tax with set parameters
...
void calc_Gross_and_Tax(double hoursWorked, double dependents, float PAYMENT_PER_HOUR = 16.78 , float SOCIAL_SECURITY_TAX = 0.06,
                        float FEDERAL_INCOME_TAX = 0.14, float UNION_DUES = 10, float WITHHELD_DEPENDENTS = 35, 
                        float OVERTIME_RATE = 1.5, float STATE_INCOME_TAX = 0.05) {
    ...
    cout << "Stick with the set payment per hour?"
